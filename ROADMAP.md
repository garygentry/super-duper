...
|---|---|---|---|
| Large-drive scan optimization and observability | Locally complete at the accepted SOP10 fixed-Release boundary; the first authorized physical two-run campaign is retained with a substage-observation gap | [`docs/scan-optimization-plan.md`](docs/scan-optimization-plan.md) and [`docs/sop10-physical-acceptance-checklist.md`](docs/sop10-physical-acceptance-checklist.md) | Obtain operator disposition of the consumed `sop10-physical-v1` observation gap. Do not rerun that identity, SOP10f v1/v2, or SOP9c V1/V2, and do not start the parked Windows stream implicitly. |
