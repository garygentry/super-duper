...
|---|---|---|---|
| Windows UI redesign | Active on `codex/ui-redesign`; direction accepted with long-scan/rescan requirements | [`plans/ui-redesign/README.md`](plans/ui-redesign/README.md) and [`plans/ui-redesign/execution-plan.md`](plans/ui-redesign/execution-plan.md) | `UIR-04c`: compact summary, measured phase bars and expandable exact details; UIR-03 complete and UIR-04a/b implemented. Use the compact session checkpoint and kickoff prompt. Baseline preserved on `wpf-poc` at `deefa40`. No production deletion enablement or consumed-campaign rerun. |
