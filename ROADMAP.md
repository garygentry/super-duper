...
|---|---|---|---|
| Windows UI redesign | Active on `codex/ui-redesign`; planning package complete, direction walkthrough next | [`plans/ui-redesign/README.md`](plans/ui-redesign/README.md) and [`plans/ui-redesign/execution-plan.md`](plans/ui-redesign/execution-plan.md) | `UIR-02`: review the concrete concept and scope, then implement/test on this same branch. Baseline preserved on `wpf-poc` at `deefa40`. No production deletion enablement or consumed-campaign rerun. |
