...
|---|---|---|---|
| Large-drive scan optimization and observability | Locally complete at the accepted SOP10 fixed-Release boundary; no dependency-ready local package remains | [`docs/scan-optimization-plan.md`](docs/scan-optimization-plan.md) and [`docs/sop10-physical-acceptance-checklist.md`](docs/sop10-physical-acceptance-checklist.md) | Await separate explicit approval for the exact physical roots, new acceptance identity, and isolated state paths. Do not reuse SOP10f v1/v2 or SOP9c V1/V2, and do not start the parked Windows stream implicitly. |
