...
|---|---|---|---|
| Windows UI redesign | Active on `codex/ui-redesign`; direction accepted with long-scan/rescan requirements | [`plans/ui-redesign/README.md`](plans/ui-redesign/README.md) and [`plans/ui-redesign/execution-plan.md`](plans/ui-redesign/execution-plan.md) | `UIR-08` in progress: local Debug/Release integration, A01-A17 mapping and strengthened A17 rescan regression complete; the prepared current-screen native walkthrough is next and separately authorized. UIR-03 complete and UIR-04a/b/c, UIR-05a/b/c, UIR-06a/b and UIR-07a/b locally implemented. NVDA/200% remain unavailable. Use the compact checkpoint and kickoff prompt. Preserve `wpf-poc` at `deefa40`; no production deletion enablement or consumed-campaign rerun. |
