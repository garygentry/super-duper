...
NVDA is not installed: its check remains unrun/unavailable. Continue independent light/dark,
contrast-theme and Windows text enlargement checks, then physical display-DPI observations.
