...
- **Next: UIR-03** — shell, semantic navigation, shared resources and independent selected/active run
  context. Validate the shell with delayed-response fixtures before moving all views.
- **UIR-04** — setup, Scan again, long-scan monitoring and terminal states. Make this the first full
