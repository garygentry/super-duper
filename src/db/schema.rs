...
diesel::table! {
    dedupe_session (id) {
        ...
        cache_map_to_dupe_vec_duration -> Float8,
        cache_map_to_dupe_vec_count -> Int4,
        db_dupe_file_insert_duration -> Float8,
