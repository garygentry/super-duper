...
- more than one page of duplicate-file groups, sorting, filtering, forward cursor paging, and
  ...
  filter, and immutable selected-root, relative-path, and drive member context;
...
- WPF startup/restoration, duplicate-file and exact-folder tabs, grid sorting, paging, filtering,
  row selection, accessible across-drives and review-summary/aggregate-location/set-explanation/
  location-span text, completed ordinary/long-path file and folder Explorer reveal commands, and
