...
- last accepted work package: `SOP2d-core-progress-projection`;
...
- Advance through dependency-ready work packages until a real stop condition in the resumable
  execution protocol applies. The next package is `SOP2e-accessible-progress-surface`; do not reopen
