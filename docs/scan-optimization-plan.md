...
- Advance through dependency-ready work packages until a real stop condition in the resumable
  execution protocol applies. `SOP2f-progress-acceptance` is blocked on the retained failed wall
  profile and an explicit operator disposition; do not advance to SOP3 or reopen
