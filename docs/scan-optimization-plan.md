...
- last accepted work package: `SOP2c-worker-progress-projection`;
...
- Advance through dependency-ready work packages until a real stop condition in the resumable
  execution protocol applies. The next package is `SOP2d-core-progress-projection`; do not reopen
