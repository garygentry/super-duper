...
- last accepted work package: `SOP8d-repeat-policy-measurement`;
...
correctness proof. The default remains provisional until SOP8d retains the declared comparison.
...
- `SOP2f-progress-acceptance` is `waived_by_operator_unmeasured`, and SOP2 is
  ...
  the dependency-ordered roadmap gates; SOP8 is next now that SOP7 is accepted.
