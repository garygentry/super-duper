...
- last accepted work package: `SOP2a-progress-contract-reducer`;
...
- Advance through dependency-ready work packages until a real stop condition in the resumable
  execution protocol applies. The next package is `SOP2b-incremental-pipeline-publication`; do not reopen
