...
- last accepted work package: `SOP2b-incremental-pipeline-publication`;
...
- Advance through dependency-ready work packages until a real stop condition in the resumable
  execution protocol applies. The next package is `SOP2c-worker-progress-projection`; do not reopen
